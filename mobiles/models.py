...
class Mobile(models.Model):
    ...
    type = models.CharField(max_length=20, choices=PhoneType.choices, blank=True, null=True, verbose_name='Тип телефона')
    operating_system = models.CharField(max_length=30, choices=OperationSystem.choices, blank=True, null=True, verbose_name='Операционная система')

    os_version_at_release = models.CharField(max_length=30, choices=OSVersion.choices, blank=True, null=True, verbose_name='Версия ОС на момент выхода')
    ...
    screen_technology = models.CharField(max_length=20, choices=ScreenTechnology.choices, blank=True, null=True, verbose_name='Технология экрана')
    refresh_rate = models.CharField(max_length=20, choices=RefreshRate.choices, blank=True, null=True, verbose_name='Частота обновления экрана', help_text='Гц')
    ram_size = models.CharField(max_length=20, choices=RamSize.choices, blank=True, null=True, verbose_name='Оперативная память')
    storage_size = models.CharField(max_length=20, choices=StorageSize.choices, blank=True, null=True, verbose_name='Встроенная память')

    main_camera_megapixels = models.CharField(max_length=10, choices=CameraMegapixels.choices, blank=True, null=True, verbose_name='Основная камера (Мп)')

    camera_specs = models.TextField(blank=True, null=True, verbose_name='Характеристики камеры')
    max_video_resolution = models.CharField(max_length=30, choices=VideoResolution.choices, blank=True, null=True, verbose_name='Максимальное разрешение видео')
    ...
    cpu_cores = models.CharField(max_length=25, choices=CpuCores.choices, blank=True, null=True, verbose_name='Количество ядер процессора')

    cpu_architecture = models.CharField(max_length=50, blank=True, null=True, verbose_name='Архитектура процессора')

    process_technology = models.CharField(max_length=5, choices=ProcessTechnology.choices, blank=True, null=True, verbose_name='Техпроцесс')
    ...
    body_construction = models.CharField(max_length=40, choices=BodyConstruction.choices, blank=True, null=True, verbose_name='Конструкция корпуса')

    stereo_speakers = models.BooleanField(default=False, verbose_name='Стереодинамики')

    frame_material = models.CharField(max_length=40, choices=FrameMaterial.choices, blank=True, null=True, verbose_name='Материал рамки')

    back_cover_material = models.CharField(max_length=20, choices=BackCoverMaterial.choices, blank=True, null=True, verbose_name='Материал задней крышки')

    frame_color = models.CharField(max_length=50, blank=True, null=True, verbose_name='Цвет рамки')
    back_cover_color = models.CharField(max_length=40, choices=BackCoverColor.choices, blank=True, null=True, verbose_name='Цвет задней крышки')
    ...
    screen_colors = models.CharField(max_length=50, blank=True, null=True, verbose_name='Количество отображаемых цветов')
    ...
    optical_zoom = models.CharField(max_length=30, choices=OpticalZoom.choices, blank=True, null=True, verbose_name='Оптический зум')

    main_camera_aperture = models.CharField(max_length=20, choices=MainCameraAperture.choices, blank=True, null=True, verbose_name='Диафрагма основной камеры')
    ...
    front_camera_position = models.CharField(max_length=50, blank=True, null=True, verbose_name='Расположение фронтальной камеры')
    ...
    front_camera_aperture = models.CharField(max_length=20, blank=True, null=True, verbose_name='Диафрагма фронтальной камеры')
    front_max_video_resolution = models.CharField(max_length=50, blank=True, null=True, verbose_name='Максимальное видео фронтальной камеры')
    ...
    bluetooth_audio_codecs = models.CharField(max_length=100, choices=BluetoothAudioCodecs.choices, blank=True, null=True, verbose_name='Аудиокодеки Bluetooth')
    ...
    connector_type = models.CharField(max_length=50, choices=ConnectorType.choices, blank=True, null=True, verbose_name='Тип разъёма')

    nfc = models.BooleanField(default=False, verbose_name='NFC')

    battery_type = models.CharField(max_length=50, choices=BatteryType.choices, blank=True, null=True, verbose_name='Тип аккумулятора')

    battery_capacity = models.PositiveIntegerField(blank=True, null=True, verbose_name='Ёмкость аккумулятора (мА·ч)')

    battery_design = models.CharField(max_length=50, choices=BatteryDesign.choices, blank=True, null=True, verbose_name='Конструкция аккумулятора')

    max_video_playback_time = models.CharField(max_length=50, blank=True, null=True, verbose_name='Время воспроизведения видео')
